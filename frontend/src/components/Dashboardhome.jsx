      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 p-6 rounded-xl mb-6 shadow-sm">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex gap-2">
            <button className="inline-flex items-center px-3 py-2 text-sm font-medium rounded-md border border-gray-300 bg-white text-gray-700 hover:bg-gray-50 transition-colors">
              <svg
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all">
            <div className="p-5">
              ...
              <h3 className="text-lg font-semibold mb-1">Protein Structure</h3>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all">
            <div className="p-5">
              ...
              <h3 className="text-lg font-semibold mb-1">Molecule Library</h3>
              <p className="text-gray-500 text-sm mb-3">Browse your saved molecules</p>
              <Link
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all">
            <div className="p-5">
              ...
              <h3 className="text-lg font-semibold mb-1">Research Data</h3>
              <p className="text-gray-500 text-sm mb-3">Access your research datasets</p>
              <Link
                to="/dashboard/data"
                className="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium text-sm"
              >
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-all">
            <div className="p-5">
              ...
              <p className="text-gray-500 text-sm mb-3">View insights and statistics</p>
              <Link
